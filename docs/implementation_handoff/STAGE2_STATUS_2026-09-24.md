...
`bash scripts/verify_handoff.sh --offline` passed all 12 dependency, format, warning-free test compilation and default ExUnit checks. Local status file: `/tmp/fount-handoff-offline-20260924T184233-348975/status.tsv`.
