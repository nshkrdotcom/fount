defmodule Fount.Repo.Migrations.CreateWritingModel do
  use Ecto.Migration
...
"""
  ...
  def down do
    execute "DROP TABLE acceptances CASCADE"
    execute "DROP TABLE analysis_report_sources CASCADE"
    execute "DROP TABLE analysis_reports CASCADE"
    execute "DROP TABLE writing_candidates CASCADE"
    execute "DROP TABLE writing_sessions CASCADE"
    execute "DROP TABLE authored_items CASCADE"
    execute "DROP TABLE mention_candidates CASCADE"
    execute "DROP TABLE mentions CASCADE"
    execute "DROP TABLE character_aliases CASCADE"
    execute "DROP TABLE characters CASCADE"
    execute "DROP TABLE elements CASCADE"
    execute "DROP TABLE dialogue_blocks CASCADE"
    execute "DROP TABLE scenes CASCADE"
    execute "DROP TABLE title_entries CASCADE"
    execute "DROP TABLE revisions CASCADE"
    execute "DROP TABLE import_artifacts CASCADE"
    execute "DROP TABLE screenplays CASCADE"
  end
end
