...
- Closed screenplay tool catalog with 16 deterministic and bounded investigation tools (`inventory`, `extract_story`, `search`, `check_constraints`, `knowledge_trace`, `locate_boundary`, `dependencies`, `continuity`, `scene_mechanics`, `dialogue`, `voice`, `action`, `compare`, `scene_lift`, `ablate`, `strategy_contrast`)
